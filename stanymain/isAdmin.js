 ...
 * @param {string} chatId - Group ID (must end with @g.us)
 * @param {string} senderId - User ID to check
 * @returns {Promise<Object>} { isSenderAdmin, isBotAdmin }
 */
async function isAdmin(sock, chatId, senderId) {
    try {
        ...
        return { isSenderAdmin: false, isBotAdmin: false, isGroup: false, error: err.message };
    }
}
